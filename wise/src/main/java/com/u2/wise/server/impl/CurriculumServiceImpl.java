...
public class CurriculumServiceImpl implements CurriculumService{
	...
	//@Cacheable(cacheNames= ConstantsUtils.CACHE_NAME_OF_Curriculum,key = "#{id}")
	...
	public Page<Record> pageList(int pageNum, int pageSize,Map<String, String> paraMap,String sort,String order) {
		...
		SqlPara para = Db.getSqlPara("curriculum.pageList", Kv.by("params", paraMap).set("sort", sort).set("order", order));
